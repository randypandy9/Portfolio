...
interface Player {
    ...
    /**
     * viewCards: This method allows the dealer to show all 
     * the cards that were
     * played after a hand is finished. If the player is card 
     * counting, they
     * will need this info
     */
    ...
    /**
     * newDeck. This method is called by the dealer to tell 
     * them the deck has
     * been re-shuffled
     */
    void newDeck();
