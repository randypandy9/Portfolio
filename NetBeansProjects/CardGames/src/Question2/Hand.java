...
public class Hand implements Iterable, Serializable {
    ...
    public boolean removeAllCards(Hand cardcollection) {
        //boolean to return
        boolean ok = false;
        //if this hand has cards and cardcollection has less or 
        //equal number of cards then execute
        ...
        for (int i = 0; i < myCards.size(); i++) {
            ...
            if (tempcard.getRank() == Rank.ACE) {
                ...
                if (!myCardsScore.isEmpty()) {
                    ...
                    myCardsScore.add(myCardsScore.get(
                            myCardsScore.size()-1)+ 11);
                } else {
